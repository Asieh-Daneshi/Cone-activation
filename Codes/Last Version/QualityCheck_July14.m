...
myVideo_unstab=VideoReader([PathName,filesep,videoName_unstab]);
fNom=myVideo_unstab.FrameRate*myVideo_unstab.Duration;
fNom_stab=myVideo.FrameRate*myVideo.Duration;
for n=1:fNom_stab
